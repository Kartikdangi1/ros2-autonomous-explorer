...
Modular design:
  - OccupancyMapManager  (autonomous_explorer.mapping)    — map sync + expansion
  - PoseProvider         (autonomous_explorer.localization) — TF2 pose lookups
  - NBV algorithms       (autonomous_explorer.nbv_utils)   — OutlineExtractor etc.
"""
...
from autonomous_explorer.nbv_utils import (
    OutlineExtractor,
    CandidateGenerator,
    NBVScorer,
    GoalValidator,
